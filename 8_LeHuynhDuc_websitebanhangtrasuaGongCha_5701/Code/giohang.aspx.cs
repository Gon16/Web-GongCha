    ...
    public partial class giohang : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                dgvGioHang.DataBind();
                lblSum.Text = "GIỎ HÀNG HIỆN TẠI CỦA BẠN CÓ " + cart.Compute("Count(mahh)", "").ToString() + " MÓN HÀNG " +
        ...
        protected void dgvGioHang_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        {
            Session["cart"] = null;
            Response.Redirect("~/Code/Thucdon.aspx");
        }
